...
class MusicFile(models.Model):
    ...
    name = models.CharField(max_length=260)
    title = models.CharListField(blank=True, null=True, default=None)
    artist = models.CharListField(blank=True, null=True, default=None)
    album = models.CharListField(blank=True, null=True, default=None)
